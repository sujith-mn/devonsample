package com.test.hrms.general.common.api;

import java.security.Principal;

import com.test.hrms.general.common.api.datatype.Role;

/**
 * This is the interface for the profile of a user interacting with this application. Currently this can only be a
 * {@link com.capgemini.staffmanagement.dataaccess.api.StaffMemberEntity} however in the future a customer may login and
 * make a reservation, etc.<br/>
